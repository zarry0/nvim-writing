...
function M.setup()
  ...
  vim.api.nvim_create_user_command("WriteSpellAdd", function(opts)
    require("writing.core.spell").add_personal(opts.args)
  end, { nargs = "?", desc = "Añadir palabra a la lista personal" })

  vim.api.nvim_create_user_command("WriteSpellRemove", function(opts)
    require("writing.core.spell").remove_personal(opts.args)
  end, { nargs = "?", desc = "Eliminar palabra de la lista personal" })

  vim.api.nvim_create_user_command("WriteSpellIgnore", function(opts)
    require("writing.core.spell").ignore_file(opts.args)
  end, { nargs = "?", desc = "Ignorar palabra sólo en el archivo actual" })

  vim.api.nvim_create_user_command("WriteSpellUnignore", function(opts)
    require("writing.core.spell").unignore_file(opts.args)
  end, { nargs = "?", desc = "Volver a comprobar una palabra en el archivo actual" })
  ...
  map({ "n", "x" }, "<leader>ws", "z=", { desc = "Writing: sugerencias ortográficas" })
  map("n", "<leader>wa", function()
    require("writing.core.spell").add_personal(nil, false)
  end, { desc = "Writing: añadir al diccionario" })
  map("x", "<leader>wa", function()
    require("writing.core.spell").add_personal(nil, true)
  end, { desc = "Writing: añadir selección al diccionario" })
  map("n", "<leader>wA", function()
    require("writing.core.spell").remove_personal(nil, false)
  end, { desc = "Writing: quitar del diccionario" })
  map("x", "<leader>wA", function()
    require("writing.core.spell").remove_personal(nil, true)
  end, { desc = "Writing: quitar selección del diccionario" })
  map("n", "<leader>wi", function()
    require("writing.core.spell").ignore_file(nil, false)
  end, { desc = "Writing: ignorar en este archivo" })
  map("x", "<leader>wi", function()
    require("writing.core.spell").ignore_file(nil, true)
  end, { desc = "Writing: ignorar selección en este archivo" })
  map("n", "<leader>wI", function()
    require("writing.core.spell").unignore_file(nil, false)
  end, { desc = "Writing: volver a comprobar aquí" })
  map("x", "<leader>wI", function()
    require("writing.core.spell").unignore_file(nil, true)
  end, { desc = "Writing: volver a comprobar selección" })
